...
import styled, {ThemeContext, css as css$1, keyframes, ThemeProvider} from 'styled-components'
...
function useDatepicker(_a) {
  ...
  var goToPreviousMonths = useCallback(
    function () {
  ...
  var goToPreviousMonthsByOneMonth = useCallback(
    function () {
  ...
  var goToNextMonths = useCallback(
    function () {
      setActiveMonths(getNextActiveMonth(activeMonths, numberOfMonths, 1))
      setFocusedDate(null)
    },
  ...
  var goToNextMonthsByOneMonth = useCallback(
    function () {
      setActiveMonths(getNextActiveMonth(activeMonths, numberOfMonths, 1, 1))
      setFocusedDate(null)
    },
  ...
  var goToPreviousYear = useCallback(
    function (numYears) {
      if (numYears === void 0) {
        numYears = 1
      }
...
var DatepickerContext = React.createContext(datepickerContextDefaultValue)
    ...
    React.createElement(
      ...
      weekdayLabels.map(function (weekdayLabel) {
        return React.createElement(
          ...
          React.createElement(MonthLabel$1, {label: weekdayLabel}),
        )
      }),
    ),
    React.createElement(
...
var RedoIconStyle = styled(CaretIcon)(
        ...
        showSelectedDates &&
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(SelectDate, {
...
var Datepicker$1 = React.forwardRef(Datepicker)
